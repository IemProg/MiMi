...
class TFDataset(torch.utils.data.Dataset):
    def __init__(self, cfg, split):
        assert split in {
            ...
            split, cfg.DATASET)
        print("Constructing {} dataset {}...".format(cfg.DATA.DATASET, split))
        ...
        self.num_classes = self.get_class_num()
    ...
    def get_data(self, cfg, split):
        ...
        print("Number of classes: {} / {}".format(len(self._class_ids), self.get_class_num()))
...
def build_tf_dataset(cfg, mode):
    ...
    vtab_dataname = cfg.DATA.DATASET# .split("vtab-")[-1]
