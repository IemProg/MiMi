...
"learn_phm": True, "factorized_phm": True, "shared_phm_rule": False,
...
class HyperComplexAdapter(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0., config_PHM = Compacter_params, reduction_factor = 32):
        super().__init__()
...
class SwinTransformerCompacter(nn.Module):
    r""" Swin Transformer
