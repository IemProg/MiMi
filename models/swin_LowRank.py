...
LowRank_params = {"train_task_adapters": True,
...
class LowRankAdapter(nn.Module):
    ...
    """
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0., config_PHM = LowRank_params, reduction_factor = 32):
        super().__init__()
        ...
        self.down_sampler = LowRankLinear(self.input_dim, self.down_sample_size,
                                          w_init=config_PHM["low_rank_w_init"],
                                          rank=config_PHM["low_rank_rank"])
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
        ...
        # Parallel Adapters
        self.parallel_mlp1 = LowRankAdapter(in_features=dim, hidden_features=mlp_hidden_dim, act_layer=act_layer, drop=drop, reduction_factor = param_ratio)
        self.parallel_mlp2 = LowRankAdapter(in_features=dim, hidden_features=mlp_hidden_dim, act_layer=act_layer, drop=drop, reduction_factor = param_ratio)
...
class SwinTransformerLowRank(nn.Module):
    r""" Swin Transformer
