...
data_dir = "/data/vtab/"  # TODO: setup the data_dir to put the the data to, the DATA.DATAPATH value in config
...
# dataset_builder.download_and_prepare()
#
# # patch_camelyon TODO: this dataset cannot be downloaded !!!!!!
